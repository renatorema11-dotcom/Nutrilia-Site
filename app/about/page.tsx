    ...
    <div className="w-full relative overflow-hidden">
      ...
      <section className="relative pt-24 pb-16 px-lg max-w-7xl mx-auto text-center">
        ...
        <p className="text-base text-on-surface-variant max-w-2xl mx-auto">
          We blend earthy wellness wisdom with intelligent computational precision to create a platform that feels human but acts with clinical certainty.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-10 md:p-12 rounded-[2.5rem] bg-on-background text-on-primary border border-outline/20 group">
            ...
            <p className="text-base text-surface-variant leading-relaxed opacity-90">
              To democratize precision health through a platform that is as empathetic as a person and as accurate as a scientist. We strive to remove the guesswork from nutrition, one meal at a time.
            </p>
          </div>

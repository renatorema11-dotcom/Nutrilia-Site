...
import { MapPin, Mail, Phone, Compass, Share2, Globe, Users, MonitorPlay } from 'lucide-react';
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input type="text" placeholder="Jane Doe" className="w-full bg-surface px-4 py-3 rounded-lg border border-outline-variant form-focus-ring transition-all" />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold text-on-surface-variant tracking-wider ml-1">EMAIL ADDRESS</label>
                <input type="email" placeholder="jane@example.com" className="w-full bg-surface px-4 py-3 rounded-lg border border-outline-variant form-focus-ring transition-all" />
              </div>
            </div>
            
            <div className="space-y-2">
              <label className="text-xs font-bold text-on-surface-variant tracking-wider ml-1">SUBJECT</label>
              <select className="w-full bg-surface px-4 py-3 rounded-lg border border-outline-variant form-focus-ring transition-all">
                <option>Precision Nutrition Inquiry</option>
            ...
            <div className="space-y-2">
              ...
              <textarea placeholder="Tell us more about your needs..." rows={5} className="w-full bg-surface px-4 py-3 rounded-lg border border-outline-variant form-focus-ring transition-all placeholder:text-outline"></textarea>
            </div>
            
            <button type="submit" className="w-full bg-primary text-on-primary py-4 rounded-xl font-semibold text-sm hover:bg-primary-container transition-colors shadow-sm active:scale-[0.98]">
              Send Message
            </button>
          </form>
        </div>
